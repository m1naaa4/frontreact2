...
import { GetMentor, UpdateMentorAction } from '../../../store/actions/Mentor/MentorActions';
import assistanceMentorCreate from '../../../data/assistanceMentorCreate';
import typeMentorCreate from '../../../data/typeMentorCreate';

export default function FinalStepMentor({ navigation}) {
    ...
    const handleChange = (selected) => {
        ...
        dispatch(UpdateMentorAction(data, '/update'));
    };
    ...
    const goToShowproject = () => {
        history.push('/mentor/show/' + projectId);
    };
    ...
    useEffect(() => {
        ...
        setCountry(project.zone);
        setOptionSelected(project.visibility)
        setAssistance(project.assistance);
                                    ...
                                    <div className="form-inputs review-box">
                                        {loadedProject && 
                                            ...
                                            <div className="review-meta">
                                                ...
                                                <div className="review-meta-item">
                                                    <label htmlFor="">{t(`${assistance}`)}</label>
