...
export default function ContentMain() { 
    ...
    const contents = useSelector(state => state.setting.contents);
                        ...
                        <Tab.Container id="left-tabs-example" defaultActiveKey="first" key={index}>
                            <Row>
                                ...
                                <Nav variant="pills" className="flex-column">
                                    <Nav.Item>
                                        <Nav.Link eventKey={content.id}>{content.name}</Nav.Link>
                                    </Nav.Item>
                                ...
                                <Col sm={9}>
                                <Tab.Content>
                                    <Tab.Pane eventKey={content.id}>
                                        {/* <Member team={content} roles={roles}/> */}
                                    </Tab.Pane>
