                                                ...
                                                <span className='mt-3'>
                                                    {project.project.owner && project.project.owner.map((value) => {
                                                        return <div className="Contact">
                                                            ...
                                                            <div className="Contact-Thumb"> <Link to={`/profile/${value.profile_id}`}><img src={value.avatar} alt="" /></Link></div>
                                                            <div className="Contact-Infos">
                                                                <Link to={`/profile/${value.profile_id}`}><h4>{value.username}</h4></Link>
                                                            </div>
                                                            <div className="Add-Contact">
                                                                <button type="button" name="button" onClick={() => { addFriend(value.profile_id); setShow(false) }}><i className="uil uil-user-plus"></i></button>
                                                            </div>
                                                        </div>
                                                    }
                                                    )}
