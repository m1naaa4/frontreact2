  ...
  var EmojiPicker = function () {
    ...
    _createClass(EmojiPicker, [{
      ...
      value: function generateElements(emojiInput) {
        ...
        emojiPicker.style.boxShadow = "0px 0px 20px 0px rgba(0, 0, 0, 0.2)";
        emojiPicker.style.borderRadius = "15px";
        ...
        emojis.map(function (item) {
          ...
          emojiLink.style.margin = "0";
          emojiLink.style.flex = "0 0 16.66%";
          emojiLink.style.maxWidth = "16.66%"; 
          emojiLink.style.display = "flex";
          emojiLink.style.justifyContent = "center";
          emojiLink.style.alignItems = "center";
